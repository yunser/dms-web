...
import styles from './tag-push.module.less';
...
export function TagPushModal({ tag, config, event$, projectPath, onSuccess, onCancel }) {
    ...
    async function handleOk() {
        ...
        let res = await request.post(`${config.host}/git/tag/push`, {
            projectPath,
