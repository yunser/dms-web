...
import styles from './influxdb-connect.module.less';
...
export function InfluxdbConnect({ config, event$, onConnect, }) {
...
// }`)
    ...
    async function loadList() {
        ...
        setLoading(true)
        let res = await request.post(`${config.host}/influxdb/connection/list`, {
            // projectPath,
            // connectionId,
            // sql: lineCode,
            // tableName,
