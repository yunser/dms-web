...
import styles from './mongo-index.module.less';
...
export function MongoIndex({ config, curDb, curCollection, event$, connectionId, }) {
    ...
    async function loadDocuments() {
        ...
        let res = await request.post(`${config.host}/mongo/index/list`, {
            connectionId,
            database: curDb.name,
