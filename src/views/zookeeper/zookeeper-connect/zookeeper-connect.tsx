...
import styles from './zookeeper-connect.module.less';
...
export function ZookeeperConnect({ config, event$, onConnect, }) {
...
// }`)
    ...
    async function loadList() {
        ...
        setLoading(true)
        let res = await request.post(`${config.host}/zookeeper/connection/list`, {
            // projectPath,
            // connectionId,
            // sql: lineCode,
            // tableName,
