        ...
        resources: {
            ...
            zh: {
                translations: {
                    ...
                    'listening': '正在监听',
                    'log': '日志',
                    'create_websocket_server': '创建 WebSocket 服务',
                    'close_websocket_server': '关闭 WebSocket 服务',
                    'all_client': '全部客户端',
                    'send_message_to': '发送消息给',
                    'create_tcp_server': '创建 TCP 服务',
                    'close_tcp_server': '关闭 TCP 服务',
                    'close_all_tcp_server': '关闭所有 TCP 服务',
                    'server_close': '服务已关闭',
